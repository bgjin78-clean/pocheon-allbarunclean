...
function seoContent(placeName, isSubRegion, parentGu) {
  ...
  return `
    ...
    <p>${fullPlace}에서는 유품정리, 고독사청소, 특수청소와 함께 쓰레기집청소, 빈집정리, 가정·이사·폐업폐기물처리 상담이 꾸준히 접수됩니다. 포천시는 시내 동지역과 소흘읍, 넓은 면 지역이 함께 있어 아파트·빌라·단독주택·농가·상가 등 현장 형태가 다양하며, 작업 전 차량 진입과 반출 동선 상담이 중요합니다.</p>
    <h3>${fullPlace} 지역 특성과 작업 포인트</h3>
    <p>${localNote}</p>
    <h3>${fullPlace} 유품정리 비용은 어떻게 결정될까요?</h3>
    <p>유품정리 비용은 평수만으로 정해지지 않습니다. 유품의 양, 폐기물 반출량, 가구·가전 크기, 엘리베이터·주차 환경, 특수청소 필요 여부가 함께 반영됩니다. 포천시는 소흘읍·시내권 아파트와 외곽 면 지역의 단독주택·농가가 함께 있어 같은 서비스라도 반출 거리와 차량 진입 조건에 따라 작업 계획이 달라질 수 있습니다.</p>
...
function getLocalNote(placeName, isSubRegion, parentGu) {
  const notes = {
    "동지역": "포천동·선단동 시내권은 행정·상업·주거가 밀집해 빌라·아파트·상가 정리 상담이 많습니다. 골목 진입과 주차 공간 확인이 비용 산정에 영향을 줍니다.",
    "읍지역": "소흘읍은 포천시에서 인구가 가장 많은 생활권으로, 송우 일대 아파트·상가·신축 단지 이사폐기물과 가정폐기물 상담이 집중됩니다.",
    "면지역": "군내·내촌·가산·신북·일동·이동·영북 등 면 지역은 단독주택·농가·창고형 공간이 많아 차량 진입로와 반출 거리 확인이 중요합니다.",
    "포천동": "신읍·어룡 일대 시내 중심권으로 주택·상가·오피스 혼재 현장이 많아 가정폐기물·폐업폐기물·유품정리 상담이 꾸준합니다.",
    "선단동": "선단·동교·설운·자작 일대 주거·상업 생활권으로 아파트·빌라 이사 전 정리와 빈집정리 수요가 있습니다.",
    "소흘읍": "송우 일대와 광릉 방향 주거지가 밀집해 대단지·빌라 이사폐기물과 가정폐기물 대량 반출 상담이 많습니다. 엘리베이터·지하주차장 동선 확인이 중요합니다.",
    "군내면": "시청·시내와 가까운 면 지역으로 단독주택·상가 정리와 빈집정리 문의가 접수됩니다.",
    "내촌면": "내촌 일대 주택·농가 혼재 지역으로 장기 방치 공간과 창고형 폐기물 반출 상담이 있습니다.",
    "가산면": "가산 생활권 단독주택·공장·창고 현장이 있어 폐업·이사 후 잔짐 정리 문의가 있습니다.",
    "신북면": "신북·호국로 방향 외곽 주거지로 단독주택 유품정리와 빈집정리 상담이 많습니다.",
    "창수면": "창수 일대 외곽 생활권으로 넓은 주택·농가 정리 시 차량 진입과 반출 거리 확인이 필요합니다.",
    "영중면": "영중 방향 면 지역으로 단독주택·창고 정리와 가정폐기물 반출 상담이 있습니다.",
    "일동면": "일동 생활권은 주거·상가가 함께 있어 이사폐기물과 빈집정리 수요가 꾸준합니다.",
    "이동면": "이동 일대 넓은 면적으로 단독주택·농가·창고형 공간 정리 상담이 많습니다.",
    "영북면": "영북 방향 북부 외곽으로 장기 방치 빈집·농가 정리 문의가 접수됩니다.",
    "관인면": "관인 일대 외곽 생활권으로 차량 진입로와 반출 거리 확인이 중요한 지역입니다.",
    "화현면": "화현 방향 외곽 면 지역으로 단독주택·농가 폐기물 반출과 빈집정리 상담이 있습니다."
  };
  if (isSubRegion && notes[placeName]) return notes[placeName];
  if (!isSubRegion && notes[placeName]) return notes[placeName];
  return `${placeName} 일대는 포천시 생활권 특성에 맞춰 아파트, 빌라, 단독주택, 농가, 상가 등 다양한 현장 상담이 가능합니다.`;
}
  ...
  <section class="gallery-block" id="area">
    <div class="wrap">
      <div class="title">
        <span>REGION</span>
        <h2>${city} 서비스 지역</h2>
        <p>동지역 · 읍지역 · 면지역 및 주요 읍·면·동 단위 안내입니다.</p>
      </div>
  ...
  <section class="related-section" id="related">
    <div class="wrap">
      ...
      <div class="related-grid">
        ...
        <a href="https://yupum.allbarunclean.com/regions/pocheon/" class="related-card" target="_blank" rel="noopener">
          <h3>경기 올바른유품</h3>
          <p>포천시 유품정리, 고독사청소, 특수청소 전문 안내</p>
          <span>yupum.allbarunclean.com →</span>
        </a>
        <a href="https://waste.allbarunclean.com/gyeonggi/pocheon.html" class="related-card" target="_blank" rel="noopener">
          <h3>경기 올바른폐기물</h3>
          <p>포천시 쓰레기집청소, 빈집정리, 가정·이사·폐업폐기물처리</p>
